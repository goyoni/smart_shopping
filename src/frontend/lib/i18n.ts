...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "cross_seller.title": "Sellers with multiple items",
    "cross_seller.carries_items": "Carries {count} of your items:",
    "cross_seller.total": "Total:",
    "table.seller": "Seller",
    "table.price": "Price",
    "table.contact": "Contact",
    "list.remove": "Remove from list",
    "domain_health.title": "Domain Health",
    "domain_health.domain": "Domain",
    "domain_health.success_rate": "Success Rate",
    "domain_health.status": "Status",
    "domain_health.healthy": "Healthy",
    "domain_health.degraded": "Degraded",
    "domain_health.blocked": "Blocked",
  ...
  he: {
    ...
    "cross_seller.title": "מוכרים עם מספר פריטים",
    "cross_seller.carries_items": "מחזיק {count} מהפריטים שלך:",
    "cross_seller.total": "סה\"כ:",
    "table.seller": "מוכר",
    "table.price": "מחיר",
    "table.contact": "יצירת קשר",
    "list.remove": "הסר מהרשימה",
    "domain_health.title": "בריאות דומיינים",
    "domain_health.domain": "דומיין",
    "domain_health.success_rate": "אחוז הצלחה",
    "domain_health.status": "סטטוס",
    "domain_health.healthy": "תקין",
    "domain_health.degraded": "ירוד",
    "domain_health.blocked": "חסום",
  ...
  ar: {
    ...
    "cross_seller.title": "بائعون بعناصر متعددة",
    "cross_seller.carries_items": "يحمل {count} من عناصرك:",
    "cross_seller.total": "المجموع:",
    "table.seller": "البائع",
    "table.price": "السعر",
    "table.contact": "اتصل",
    "list.remove": "إزالة من القائمة",
    "domain_health.title": "صحة النطاقات",
    "domain_health.domain": "النطاق",
    "domain_health.success_rate": "معدل النجاح",
    "domain_health.status": "الحالة",
    "domain_health.healthy": "سليم",
    "domain_health.degraded": "متدهور",
    "domain_health.blocked": "محظور",
